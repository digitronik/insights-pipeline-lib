class pipelineVars implements Serializable {
    ...
    String seleniumImage = 'quay.io/app-sre/selenium-standalone-chrome:136.0-20250828'
    String playwrightImageRepo = 'quay.io/insights-qe/playwright-vnc'
    String defaultPlaywrightBrowser = 'chrome'
    String defaultPlaywrightVersion = '1.58.2'
